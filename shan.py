...
TOKEN = '7608387188:AAFW3bu7BEnbrH-wq_hcVagT7qFq5tptUjg'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -4572404715
CHANNEL_ID = -4572404715
error_channel_id = -4572404715
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*Choose an option - t.me/shan_ddos:*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/shan_ddos/1744*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@shantanu24_6 main channel - t.me/shan_ddos*", parse_mode='Markdown')
    else:
